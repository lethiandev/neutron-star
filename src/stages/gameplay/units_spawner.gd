...
func _spawn_wave_1() -> GDScriptFunctionState:
...
func _spawn_mothership_boss() -> GDScriptFunctionState:
...
func _spawn_spaceship(p_delay: float, p_duration: float, p_from: Vector2) -> GDScriptFunctionState:
...
func _delay(p_delay: float) -> GDScriptFunctionState:
